<div id="hero-block" class="hero-block">
    ...
    <div class="container">
        <div class="hero-text-block">
            ...
            <div class="hero-intro mb-4">Курчатовский геномный центр <br/> Никитского ботанического сада <br><span class="text-secondary">Конференция завершилась</span></div>
            <div class="hero-cta">
                {{-- <a class="btn btn-primary btn-lg" href="{{ LaravelLocalization::localizeUrl('/register') }}">{{ __('main.participate')}}</a> --}}
                {{-- <a class="btn btn-outline-dark btn-link btn-lg" href="#program-section"><img class="me-2" width="40" src="{{asset('/images/green-yandex-disk.svg')}}">{{ __('main.photos_view')}}</a> --}}
