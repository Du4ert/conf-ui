<section id="speakers-section" class="speakers-section section">
    <div class="container">
        ...
        <div class="section-intro text-center single-col-max mx-auto mb-5">Наши дорогие члены и членнесы</div>
        <div class="row">
            <div class="col-6 col-lg-3 mb-4">
                <div class="card rounded-0">
                    <img src="{{asset('/images/speakers/speaker-1.jpg')}}" class="card-img-top rounded-0" alt="">
                    <div class="card-body">
            ...
            <div class="col-6 col-lg-3 mb-4">
                <div class="card rounded-0">
                    <img src="{{asset('/images/speakers/speaker-2.jpg')}}" class="card-img-top rounded-0" alt="">
                    <div class="card-body">
            ...
            <div class="col-6 col-lg-3 mb-4">
                <div class="card rounded-0">
                    <img src="{{asset('/images/speakers/speaker-3.jpg')}}" class="card-img-top rounded-0" alt="">
                    <div class="card-body">
            ...
            <div class="col-6 col-lg-3 mb-4">
                <div class="card rounded-0">
                    <img src="{{asset('/images/speakers/speaker-4.jpg')}}" class="card-img-top rounded-0" alt="">
                    <div class="card-body">
            ...
            <div class="col-6 col-lg-3 mb-4">
                <div class="card rounded-0">
                    <img src="{{asset('/images/speakers/speaker-5.jpg')}}" class="card-img-top rounded-0" alt="">
                    <div class="card-body">
            ...
            <div class="col-6 col-lg-3 mb-4">
                <div class="card rounded-0">
                    <img src="{{asset('/images/speakers/speaker-6.jpg')}}" class="card-img-top rounded-0" alt="">
                    <div class="card-body">
            ...
            <div class="col-6 col-lg-3 mb-4">
                <div class="card rounded-0">
                    <img src="{{asset('/images/speakers/speaker-7.jpg')}}" class="card-img-top rounded-0" alt="">
                    <div class="card-body">
            ...
            <div class="col-6 col-lg-3 mb-4">
                <div class="card rounded-0">
                    <img src="{{asset('/images/speakers/speaker-8.jpg')}}" class="card-img-top rounded-0" alt="">
                    <div class="card-body">
