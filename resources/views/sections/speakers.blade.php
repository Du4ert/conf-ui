        ...
        <div class="row">
            <div class="col-6 col-lg-3 mb-4">
                <div class="card rounded-0">
                    <a href="#modal-speaker-1" data-bs-toggle="modal" data-bs-target="#modal-speaker-1"><img src="{{ asset('/images/speakers/speaker-1.jpg')}}" class="card-img-top rounded-0" alt=""></a>
                    <div class="card-body">
            ...
            <div class="col-6 col-lg-3 mb-4">
                <div class="card rounded-0">
                    <a href="#modal-speaker-1" data-bs-toggle="modal" data-bs-target="#modal-speaker-1"><img src="{{asset('/images/speakers/speaker-2.jpg')}}" class="card-img-top rounded-0" alt=""></a>
                    <div class="card-body">
            ...
            <div class="col-6 col-lg-3 mb-4">
                <div class="card rounded-0">
                    <a href="#modal-speaker-1" data-bs-toggle="modal" data-bs-target="#modal-speaker-1"><img src="{{asset('/images/speakers/speaker-3.jpg')}}" class="card-img-top rounded-0" alt=""></a>
                    <div class="card-body">
            ...
            <div class="col-6 col-lg-3 mb-4">
                <div class="card rounded-0">
                    <a href="#modal-speaker-1" data-bs-toggle="modal" data-bs-target="#modal-speaker-1"><img src="{{asset('/images/speakers/speaker-4.jpg')}}" class="card-img-top rounded-0" alt=""></a>
                    <div class="card-body">
            ...
            <div class="col-6 col-lg-3 mb-4">
                <div class="card rounded-0">
                    <a href="#modal-speaker-1" data-bs-toggle="modal" data-bs-target="#modal-speaker-1"><img src="{{asset('/images/speakers/speaker-5.jpg')}}" class="card-img-top rounded-0" alt=""></a>
                    <div class="card-body">
            ...
            <div class="col-6 col-lg-3 mb-4">
                <div class="card rounded-0">
                    <a href="#modal-speaker-1" data-bs-toggle="modal" data-bs-target="#modal-speaker-1"><img src="{{asset('/images/speakers/speaker-6.jpg')}}" class="card-img-top rounded-0" alt=""></a>
                    <div class="card-body">
            ...
            <div class="col-6 col-lg-3 mb-4">
                <div class="card rounded-0">
                    <a href="#modal-speaker-1" data-bs-toggle="modal" data-bs-target="#modal-speaker-1"><img src="{{asset('/images/speakers/speaker-7.jpg')}}" class="card-img-top rounded-0" alt=""></a>
                    <div class="card-body">
            ...
            <div class="col-6 col-lg-3 mb-4">
                <div class="card rounded-0">
                    <a href="#modal-speaker-1" data-bs-toggle="modal" data-bs-target="#modal-speaker-1"><img src="{{asset('/images/speakers/speaker-8.jpg')}}" class="card-img-top rounded-0" alt=""></a>
                    <div class="card-body">
