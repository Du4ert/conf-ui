    ...
    <div class="page-content-main-part policy">
        ...
        <ol>
            ...
            <li>
                ...
                сообщений, направив Оператору письмо на адрес электронной почты <a
                    href="mailto:genbio-conf2024@yandex.ru">genbio-conf2024@yandex.ru</a> с
        ...
        <ol>
            ...
            <li>
                ...
                электронной почты Оператора <a href="mailto:genbio-conf2024@yandex.ru">genbio-conf2024@yandex.ru</a> с
            ...
            <li>
                ...
                <a href="mailto:genbio-conf2024@yandex.ru">genbio-conf2024@yandex.ru</a> с пометкой «Отзыв согласия на
        ...
        <ol>
            ...
            <li>
                ...
                электронной почты <a href="mailto:genbio-conf2024@yandex.ru">genbio-conf2024@yandex.ru</a>.
            </li>
            <li>
